...
Процедура СформироватьДвижения()    
	Для каждого строка из Начисления Цикл 
		...
		Если Движение.ВидРасчета = ПланыВидовРасчета.ВКМ_ОсновныеНачисления.Отпуск Тогда			
			...
			Движение.ДнейОтпуска = (НачалоДня(строка.ДатаОкончания) - НачалоДня(строка.ДатаНачала)) / (60 * 60 * 24);; 
			Движение.ДатаНачалаОтпуска = строка.ДатаНачала;
			Движение.ДатаОкончанияОтпуска = строка.ДатаОкончания;
		КонецЕсли;
	...
	Движения.ВКМ_ДниОтпуска.Записать();
КонецПроцедуры 
