...
Процедура РассчитатьУдержания()  
	...
	|	ВКТ_Удержания.НомерСтроки КАК НомерСтроки
	|ИЗ
	|	ВКТ_Удержания КАК ВКТ_Удержания
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрРасчета.ВКМ_ОсновныеНачисления.ДанныеГрафика КАК ВКМ_ОсновныеНачисленияДанныеГрафика
	|		ПО ВКТ_Удержания.Регистратор = ВКМ_ОсновныеНачисленияДанныеГрафика.Регистратор
	|			И ВКТ_Удержания.Сотрудник = ВКМ_ОсновныеНачисленияДанныеГрафика.Сотрудник";
