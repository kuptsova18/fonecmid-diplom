...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	ВремяНачалаРабот = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ССылка,"ВКМ_ВремяНачалаРабот");
	ВремяОкончанияРабот = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ССылка,"ВКМ_ДатаПроведенияРабот");
	ДатаПроведениеРабот = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ССылка,"ВКМ_ДатаПроведенияРабот"); 
	ДатаПроведениеРабот = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ССылка,"ВКМ_ДатаПроведенияРабот");
	Специалист = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ССылка,"ВКМ_Специалист");
	Если ЭтоНовый() Тогда
	...
	ИначеЕсли ЭтотОбъект.ВКМ_ВремяНачалаРабот <> ВремяНачалаРабот Тогда
	...
	ИначеЕсли ЭтотОбъект.ВКМ_ВремяОкончанияРабот <> ВремяОкончанияРабот Тогда
	...
	ИначеЕсли ЭтотОбъект.ВКМ_ДатаПроведенияРабот <> ДатаПроведениеРабот Тогда 
	...
	ИначеЕсли ЭтотОбъект.ВКМ_Специалист <> Специалист Тогда
